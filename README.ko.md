...
| [`stupid-silent`](skills/silent/stupid-silent) | `neutral` | `silent` | Remain silent instead of answering when the user requests a no-reply joke mode. | `$skill-installer install https://github.com/ium-mui/stupid-skills/tree/main/skills/silent/stupid-silent` |
<!-- skills:end -->
